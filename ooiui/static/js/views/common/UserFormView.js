      ...
      if (this.model.isValid(true)) {
        ...
        this.model.save(null, {
          success: function(model, response) {
            //console.log('model right before login');
            //console.log(model);

            ooi.login.set({
              login: model.get('email'),
              password: model.get('password')
            });

            ooi.login.logIn();
            if(ooi.login.get('token') !== '') {
              //console.log("success");
              //this.hide();
              //this.success();
              var date = new Date();
            ...
            self.modalDialog.show({
              message: "<p>Account created, activated and you have been logged in.</p>" +
                        "<p>Close this window to return to the home page.</p>" +
                        "<p>Email the helpdesk for enhanced permissions requests.</p>",
              type: "success",
              ack: function() {
                window.location = '/';
              }
