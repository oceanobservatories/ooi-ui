...
@app.route('/api/m2m', methods=['GET', 'PUT', 'POST'], defaults={'path': ''})
@app.route('/api/m2m/<path:path>', methods=['GET', 'PUT', 'POST'])
def m2m_handler(path):
    ...
    if request.authorization:
        ...
        if request.method == 'GET':
            ...
            return 'Improper request method \'%s\', only GET, PUT and POST are supported. ' % request.method
